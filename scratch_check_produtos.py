...
print("Sample products from dash_produtos:", run_query("SELECT id_firebird, nome, preco, custo, estoque FROM dash_produtos WHERE tenant_id = 'ed1d3a98-4c4d-48db-99c0-8751926eb8e5' ORDER BY preco DESC LIMIT 10"))
