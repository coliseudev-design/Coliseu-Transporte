...
cols_companies = run_query("SELECT column_name FROM information_schema.columns WHERE table_name='companies'")
print("Columns in companies:")
print(cols_companies)

cols_modules = run_query("SELECT column_name FROM information_schema.columns WHERE table_name='company_modules'")
print("Columns in company_modules:")
print(cols_modules)
