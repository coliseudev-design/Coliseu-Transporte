...
res = run_query("""
    SELECT tenant_id::text, whatsapp_server_url, whatsapp_token, whatsapp_enabled
    FROM dash_integracoes_config
""")
if res:
    for r in res:
        print(f"Tenant: {r['tenant_id']} | URL: {r['whatsapp_server_url']} | Token: {r['whatsapp_token']} | Enabled: {r['whatsapp_enabled']}")
else:
