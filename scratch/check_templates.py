...
print("Checking non-null imagem_url templates:")
res = run_query("""
    SELECT id, nome, length(imagem_url) as len, imagem_url, subcategoria
    FROM dash_templates
    WHERE tenant_id = 'ce3067f6-04a3-4b6c-a1b8-6aa47f24aad6' AND imagem_url IS NOT NULL;
""")
if res:
    print(json.dumps(res, indent=2))
else:
    print("No templates with non-null image found.")
