...
print("=== CHECKING REAL PHONES USING ILIKE ===")
queries = ['%CIPLAN%', '%PAX PRIMAVERA%', '%TRAMONTINA%']
for q in queries:
    res = run_query(f"SELECT nome, telefone, celular_secundario FROM dash_clientes WHERE nome ILIKE '{q}' LIMIT 3")
    print(q, "->", res)
