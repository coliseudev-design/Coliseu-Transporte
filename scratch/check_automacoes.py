...
print("Checking automacoes:")
res = run_query("""
    SELECT id, tenant_id::text, template_id, ativo, gatilho, tempo_segundos, dias_vencimento
    FROM dash_automacoes
    WHERE tenant_id = 'ce3067f6-04a3-4b6c-a1b8-6aa47f24aad6'
""")
if res:
    print(json.dumps(res, indent=2))
else:
    print("No automacoes found.")
