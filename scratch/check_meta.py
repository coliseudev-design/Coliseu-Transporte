...
print("Checking Meta configurations:")
res = run_query("""
    SELECT tenant_id::text, whatsapp_api_provider, whatsapp_meta_business_id, whatsapp_meta_phone_id, whatsapp_meta_token, whatsapp_meta_verify_token, whatsapp_enabled, whatsapp_admin_phone
