...
run_query("UPDATE dash_integracoes_config SET whatsapp_token = '7bec3c90-89fe-466a-8a64-88d1d107a594';")

res = run_query("SELECT tenant_id::text, whatsapp_server_url, whatsapp_token, whatsapp_enabled, whatsapp_admin_phone FROM dash_integracoes_config;")
print("=== CONFIGS IN DB AFTER CORRECTION ===")
